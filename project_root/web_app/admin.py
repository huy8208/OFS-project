...
class ProductAdmin(admin.ModelAdmin):
    list_display = ('id','name','price','weight','category','slug','description','date_created','image','amount_in_stock')
    ordering = ('id',)
    filter_horizontal = ()
    list_filter = ()
    fieldsets = ()
...
class OrderAdmin(admin.ModelAdmin):
    list_display = ('id','customer','complete','status','payment','shipping')
